...
aliases:
  ...
  - "Hangfast"
  - "Kholdrun"
population: "9,400 above; the thanedom below does not give its numbers"
government: "Shared. The surface under the See of Salvamont and the Tower-Warden; the Deeps under the Thane of Kholdrun. Governed jointly by the Concord of Stone."
ruler: "Tower-Warden Isembard Krahe (surface); Thane Berrund of Kholdrun (below)"
alignment: "Lawful Neutral"
religions: "Church of Orzhova above; the dwarven rites below, unmolested by treaty"
languages: "Althan; Ecclesiast; Deep-tongue at the gate-markets"
...
A border city in the far north where Althania stops and the **World Spine Mountains** begin. Above the ground it is Althanian, walled, and dominated by the White Tower. Below the ground it is not Althanian at all: the rock opens into the halls of **Kholdrun**, and the seat of its Thane is a keep that hangs down from the cavern ceiling on chains and buttresses of stone, lamplit from below, with nothing under it but air.

The surface calls the whole thing Weissturm. The Deeps call it Kholdrun. The treaty calls it neither.

**At a glance.** 9,400 above ground; the thanedom below declines to be counted. Falls within the **See of [[Salvamont]]** by area, which pleases nobody. The northernmost place in the realm that the Church can honestly call its own, and the last gate before the passes.
...
The Hierarch is still styled *Keeper of the Whiteroot Stone*. He has no authority in the Tower, has never seen the stone, and the title is defended by the Curia on the grounds that it has always been held. The dwarves, who can see the roots from below, have their own opinion and keep it.

## The White Tower

The Tower is the Church's **Collegium of Sanctioned Grace**: every licensed caster in Althania is trained here, entered on the Roll here, and — in the great majority of cases — spends their life here.

The doctrine that permits this is one line, taught to every novice on the first day:
...
So they are gathered. Every child in the realm who shows the aptitude is registered by their curate, collected, and brought north. They are taught well, fed better than they were at home, and given work that matters. They are also collared: a sealed ring, an entry on the Roll, and a licence that specifies where they may go and what they may do there.

Leaving without licence makes a caster **unwritten**, and hunting the unwritten belongs to [[The 6th Sacrament - The Keepers of the Last Flame]], which regards it as the pleasantest work it has.
...
- [[The 4th Sacrament - The Arbiters of Judgment]] keeps a standing tribunal on the second stair. It has never been idle for a full year.
- [[The 1st Sacrament - The Keepers of Doctrine]] licenses every working and keeps the Roll.
- The Sixth is somewhere in the walls. Everyone assumes this. Nobody has ever identified one.
...
The dwarves of the World Spine were under this mountain before the oak was cut, and the Church's first instinct in 9 AR was the obvious one. It went badly enough that nobody wrote it down.

What followed instead was the **Concord of Stone** (214 AR), which is short, blunt, and has held: the surface is Althania's, the rock is the Thane's, the Gate is shared, neither faith preaches to the other, and every dispute goes to a joint bench of three and three with the Tower-Warden abstaining.
...
- That the roots of the Whiteroot are not dead, and that this is why the Tower was built on the stump rather than beside it.
- That the Concord of Stone has a fourth article which neither party will produce.
- That the unwritten who are hunted are not the ones who ran, but the ones the Tower reported as having run.
- That the Thane knows exactly what walks in the deep galleries under [[Salvamont]], and has known since before the Church did.
