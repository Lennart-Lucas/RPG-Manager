...
### Weapon of Fury and Fire (level 3)

<!-- rpg_feature id="feature-1" -->

At 3rd level, when you adopt this path, you learn how to channel your ferocity to improve your performance with cannons, allowing you to add your rage damage to any ranged attacks made with a cannon. You also gain resistance to [[RPG Manager/Damage Types/Thunder]] and [[RPG Manager/Damage Types/Fire]] damage while raging, as you have grown to build up a resilience to your cannon's constant loud and burning misfires.
...
### Bigger Gun, Bigger Boom (level 6)

<!-- rpg_feature id="feature-2" -->
...
Additionally, you no longer have disadvantage when attacking targets below the minimum range or within 5 feet of you with a ranged cannon attack.

### Break Things to Fix Things (level 10)

<!-- rpg_feature id="feature-1785591209512802" -->
...
### Playing With Fire (level 14)

<!-- rpg_feature id="feature-1785591240050752" -->
